...
def main():
    ...
    parser.add_argument("-m", "--match-score", type = int, default = "-", help = "Score for a match")
    parser.add_argument("-x", "--mismatch-score", type = int, default = -1, help = "Score for a mismatch")
    parser.add_argument("-j", "--indel_score", type = int, default = -2, help = "Score for instertion / deletion")
